define("dr-media-video-player", ["dr-media-abstract-player", "dr-lazyloader"], function (AbstractPlayer, LazyLoader) {
    "use strict";
    ...
    var VideoPlayer = new Class({
        ...
        buildAccessabilityControls: function () {
        ...
        /**
        * Clears the container and displays an error message.
        * See options.errorMessages
        * @param errorCode  "access_denied" | "connection_failed" | "defaultMsg" | "notFound" | "timeout" 
        */
        displayError: function (errorCode, info, logOutput, errorDetails) {
        ...
        buildErrorContainer: function(info, errorCode, errorDetails, header, paragraph) {
        ...
        isValidErrorDownloadBrowser: function() {
