require.config({
	baseUrl: (location.hostname === "beta.dr.dk" ? "//www.dr.dk" : "") + "/assets/js/",
	paths: {
		// first party
		...
		"gstream": "shared/gstream/6.04/gstream",
        "swipejs": "shared/swipejs-2/swipe",
        "iscroll": "shared/iscroll/iscroll",
        "fileupload": "shared/fileupload/upload",
		"conviva": "shared/conviva/2_64_0_68610/LivePass.js?customerId=c3.DR-DK",
